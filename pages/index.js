...
import {AlurakutMenu, AlurakutProfileSidebarMenuDefault, OrkutNostalgicIconSet} 
...
function ProfileSidebar(propriedades){
  return (
    <Box as="aside">
      <img src={`https://github.com/${propriedades.githubUser}.png`} style={{
        borderRadius:'8px'}} />
      <hr />
      <p>
      <a className="boxLink" href={`https://github.com/
  ...
  return (
    <>
      ...
      <MainGrid>
        ...
        <div className="profileRelationsArea" style={{ gridArea: 
